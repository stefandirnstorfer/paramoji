...
const emoticon_data=[
    ...
    [  0, "10*c-25",  0,25],
    copyX(26, 2), // M
    "mirror:#right-eye-outline:1a", [  8,  0,  "8-6*c"], [  0,  0,  "4*c-4"],
    "mirror:#right-eye-outline:1b", [  8,  0,  "8-6*c"], [  0,  0,  "2-2*c"],
    "mirror:#right-eye-outline:2",  [  8,  0,  "3-2*c"], [  0,  0,  "9-9*c"],
    "mirror:#right-eye-outline:3a", [  4,  0,  -1], [  0, "3*c-6", "13-12*c"],
    "mirror:#right-eye-outline:3b", [ -5, -2, "-11"], [  0, "5*c-9",  "9-7*c"],
    "mirror:#right-eye-outline:4",  [-11,  0, -6], [  0,  0,  0],
    "mirror:#right-eye-outline:5a", [ -5, -2, "-13"], [  0, "5*c-9", "8*c-9"],
    "mirror:#right-eye-outline:5b", [  4,  0, "-5"], [  0, "3*c-6", "12*c-13"],
    "mirror:#right-eye-outline:6",  [  8,  0,  0], [  0,  0, "10*c-11"],
    // right-eye
    [0,  0,  0,  2],
    // left-lid-shadow
    "#left-lid-shadow:2", [2,  1,-10, -6,  3], [  2, -9,-17,  2, 20],
    // left-eye-brow
    "#right-eye-brow:1", [ 61,  2,  0, -5], [ 44, -7,-18,  12],
    "#right-eye-brow:2", [ 72,  0,  0, -4], [ 44, -9,-18,  4],
    "#right-eye-brow:3", [ 80,  0,  4, -3], [ 44, -3,-18, -4],
    ...
    // mouth-sqeeze
    "mouth-squeeze", [1, 0, "-l/4", 0, 0, -1/4],
    // lips
    "#lips:1", [ 63,  0,  9, -1],             [  0,-11, -2,  0],
    "#lips:2", [ 60,  0, 11, -3],             [  0,  0, 11,  0,  0,  4],
    "#lips:3", [ 56,  0,  6, -2],             [  0,  2, 12,  0,  0,  8],
    /* 50 */             copyX(-1,1),
    "mirror:2#lips:2", [ 40,  0,-11,  3,  3], [  0,  0, 11,  0,  0,  4],
    "mirror:1#lips:1", [ 37,  0, -9,  1],     [  0,-11, -2,  0],
    "#lips:6",         [ 40,  0,-11,  3, -3], [  0,  0,-11,  0,-22, -4],
    "#lips:7",         [ 44,  0, -6,  2],     [  0,  2,-12,  0, -7, -9],
    /* 50 */                                  [  0,  2,-12,  0, -3, -6],
    "#lips:x7",        [ 56,  0,  6, -2],     [  0,  2,-12,  0,  1, -9],
    "mirror#lips:6",   [ 60,  0, 11, -3],     [  0,  0,-11,  0,  0, -4],
    copyX(-28, 2),
    // teeth
    ...
    copyX(-25, 2),
    // wrinkle-cheek
    "#wrinkle-left-cheek:1", [ 26, -3, -6,  0, -2,  0], [ 82, -8, -1,  0,  0,  3],
    "#wrinkle-left-cheek:2", [ 32,  0, -6,  1, -8,  7], [ 80, -2, -8,  1,-18,  2],
    "#wrinkle-left-cheek:3", [ 37, -3, -2,  0,  3],     [ 72, -3, -5,  0, -8],
...
function emoticon_svg(v, a, p, c, e, l) {
    ...
    var data = emoticon_data
        ...
        .map((C, i)=> {
            ...
            V= [1, v/50-1, Math.min(1,Math.max(0,a2 + expressable[i]*e2)), p/50-1, c, l]
            return dotprod(V, C)
        })
    var index=0;
    const template= [
        ...
        '    <clipPath id="clip-mouth"><use href="#inner-mouth"/></clipPath>',
        '  </defs>',
        ...
        '    <path d="M 49,? q -2,-2 -4,0 M 52,? Q 56,? ?,? T ?,? ?,?" id="nose-path" fill="none" stroke="black"/>',
        '  </g>',
        '  <g id="mouth" transform="translate(50,85) scale(?,1) translate(-50, 0)">',
        '    <path id="lips" d="M ?,? C ?,? ?,? 50,? S ?,? ?,? C ?,? ?,? 50,? C ?,? ?,? ?,? Z" fill="gray" stroke="black"/>',
