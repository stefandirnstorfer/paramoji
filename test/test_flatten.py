...
class FlattenTest(unittest.TestCase):
    ...
    def test_transform_use(self):
        ...
        normalize_svg(node)
        self.assertTrue('<use transform="matrix(0.5,0,0,0.5,0,0)" xlink:href="#me"/>' in node.toxml())
...
class ToCircleTest(unittest.TestCase):
    ...
    def test_to_circle(self):
        ...
        self.assertTrue('transform="matrix(10,0,0,10,12,30)' in node.toxml(), node.toxml())

        fix_circle(node.firstChild, identiy_matrix())
        self.assertTrue('transform="matrix(10,0,0,10,12,30)' in node.toxml())
    ...
    def test_to_transformed_circle(self):
        ...
        fix_circle(node.firstChild, identiy_matrix())
        self.assertTrue('transform="matrix(20,0,0,20,24,60)' in node.toxml(), node.toxml())
