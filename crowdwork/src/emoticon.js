export function emoticon_svg(v, a, p, c, e) {
    ...
    return paramoji_svg(v, a1, a2, p, c, e)
}

export function paramoji_svg(v, a1, a2, p, c, w=1.0) {
    ...
    const emoticon_data=[[51,-2,-10],[,22,,,-26],[,,-11],[-8,,-8],[,,-4],[-8,,-8],[,,2],[-8,
        ...
        6],[,,-11,,,,10],[,,,,2],[2,1,-10,,-6,3],[2,-9,-17,,4,20],[,,,,,.4],[70,-2,-2.5,
        -7.5,-1,,,,,-1],[-3,,.25,.75],[-14,-2,1.5,4.5,2],[25,-2,,-6,4,-5,,,-4],[78,-9,
        ,-2,,-1],[30,1,,-5,3,-8,,,-4],[76,-4,,-8,-1,-16,-3,5],[36,-3,-0.4,-1.6,2,3],
        [69,-3,-1.8,-7.2,-2,-5,-2,2,,1],[75,3,,6,-4],[78,-9,,-2],[70,-1,,5,-3],[76,-4,
            ,-8,-1],[64,2,.4,1.6,-2],[69,-3,-1.8,-7.2,-2],[80,4,,6,-6,,,,-2],[65,1,,-5,-1,
            ,,,-2],[14,,,9,-2],[,-12,,-2,,-3,,6,-3],[10,,,11,-3],[,-2,,11,,,,,-3],[6,,,6,
            -3],[,2,,12,,,,,-1],[,2,,12,,,,,1],[-10,,,-11,3],[,-2,,11,,,,,2],[-14,,,-9,2],
        [,-12,,-2,,-3,,6,3],[-10,,,-11,3],[,-2,,-11,,,,,-7],[-6,,,-6,3],[,2,,-12,,,,
            ,-3],[,2,,-12,,,,,-2],[10,,,11,-3],[,-2,,-11,,,,,-3],[14,,,9,-2],[,-12,,-2,,
            -3,,6,-3],[,,,,,.3,,.1,-0.1],[50,,,,,-9,,,3],[80,,,,-2,-3,,,2],[61,2,-1,,-4],
        [40,-9,-19,,12],[72,,,,-4],[40,-13,-20,,3],[80,,6,,-2],[40,-5,-18,,-3],[1+w,
            -0.5,1,,.5],[62,-1,-4,,-3],[36,-5,-18,,7],[56,1,,,-4],[42,-7,-24,,9],[56,,,,
            -2],[45,-8,-22,,10],[,,,,,1,3,2,-1]]


    const dotprod = (X,Y) => X.reduce((a, b, i) => a + b*(Y[i] || 0), 0)
    var data = emoticon_data
        .map((C, i)=> {
            const V= [1, v*2-1, a1, a2, p*2-1, c, c*a1, c*v, c*a2, c*p]
            return dotprod(V, C)
        })
    var index=0;
    const template = [
