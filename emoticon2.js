function emoticon_svg_raw2(v,a,p) {
  ...
  return [
      ...
      '	</g>',
      '	<g id="left-eye">',
      '		<path d="M ?,? C ?,? ?,? ?,? C ?,? ?,? ?,? C ?,? ?,? ?,? Z" id="left-eye-outline" style="fill:#ffffff;stroke:#000000;stroke-width:1"/>',
      '		<g clip-path="url(#clipPath-left-eye)" id="left-eyeball">',
      '			<g id="left-lens" transform="translate(95,?)">',
      ...
      '			<use id="right-lens" x="60" xlink:href="#left-lens"/>',
